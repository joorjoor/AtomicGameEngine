@echo OFF
set ATOMIC_VS2019PATH="C:\Program Files (x86)\Microsoft Visual Studio\2019\Community"
...
if "%1"=="VS2017" (
  ...
  if defined ATOMIC_VS2017PATH (
	...
	set ATOMIC_CMAKE="%ATOMIC_VS2019PATH:~1,-1%\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin\cmake.exe"
    set ATOMIC_CMAKE_GENERATOR="Visual Studio 16 2019"
	
    call "%ATOMIC_VS2019PATH:~1,-1%%\Common7\Tools\VsDevCmd.bat"
